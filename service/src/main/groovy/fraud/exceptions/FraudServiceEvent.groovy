...
enum FraudServiceEvent implements EventLogBase {
    ...
    private FraudServiceEvent(int eventId, int responseId, EventLogBase.EventType eventType, String formatString) {
        this(eventId, responseId, Level.ERROR, eventType, formatString);
    }

    private FraudServiceEvent(int eventID, int responseId, Level logLevel, EventLogBase.EventType eventType,
                              String formatString) {
